    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            for (const i of directories) {
                ...
                const relPath = utils_1.getRelFromAbs(root, absInPath);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            for (const adapter of adapters) {
                resource = yield adapter.execute(resource, logger);
            }
            const absPath = path.join(outDir, path.dirname(resource.path));
            if (!fs.existsSync(absPath)) {
                fs.mkdirSync(absPath, { recursive: true });
            }
            yield fs.writeFile(path.join(outDir, resource.path), resource.content);
