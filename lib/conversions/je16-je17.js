...
const WarnAdapter_1 = require("../adapters/general/WarnAdapter");
...
exports.JE16ToJE17 = {
    ...
    adapters: [
        ...
        new PathAdapter_1.default({
            operations: [
                {
                    filter: new resource_filter_1.default('textures', [/^minecraft:items\/fish_cooked$/], ['png', 'png.mcmeta']),
                    set: 'minecraft:items/fish_cod_cooked'
                },
                {
                    filter: new resource_filter_1.default('textures', [/^minecraft:items\/fish_raw$/], ['png', 'png.mcmeta']),
